...
class TrialsControllerTest < ActionController::TestCase
  ...
  test "should create trial" do
    assert_difference('Trial.count') do
      post :create, trial: { published: @trial.published, published_datetime: @trial.published_datetime, title: @trial.title, user_id: @trial.user_id }
    end
  ...
  test "should update trial" do
    put :update, id: @trial, trial: { published: @trial.published, published_datetime: @trial.published_datetime, title: @trial.title, user_id: @trial.user_id }
    assert_redirected_to trial_path(assigns(:trial))
  end
